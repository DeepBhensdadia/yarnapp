...
class Teampoints {
  ...
  factory Teampoints.fromJson(Map<String, dynamic> json) => Teampoints(
    ...
    totalMatches: json["total_played_count"],
    totalWin: json["total_win_count"],
    totalLoss: json["total_loss_count"],
    totalDraw: json["total_draw_count"],
    point: json["points"],
    netRunrate: json["nrr"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "status": status,
    "group_id": groupId,
    "total_played_count": totalMatches,
    "total_win_count": totalWin,
    "total_loss_count": totalLoss,
    "total_draw_count": totalDraw,
    "points": point,
    "nrr": netRunrate,
    "is_delete": isDelete,
