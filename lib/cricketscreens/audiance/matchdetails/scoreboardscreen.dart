                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(
                                          index == 0
                                              ? "${startmatch.matchlive.value.team1Runs}-${startmatch.matchlive.value.team1TotalWickets} (${startmatch.matchlive.value.team1TotalOver})"
                                              : "${startmatch.matchlive.value.team2Runs}-${startmatch.matchlive.value.team2TotalWickets} (${startmatch.matchlive.value.team2TotalOver})",
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 14,
                                              fontWeight: FontWeight.bold),
                                        ...
                                        Text(
                                          "CRR  ${index == 0 ? startmatch.scroreboard.value.data?.team1Crr : startmatch.scroreboard.value.data?.team2Crr}",
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 12,
                                              fontWeight: FontWeight.bold),
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Text(
                                        "CRR  ${index == 0 ? startmatch.scroreboard.value.data?.team1Crr ?? "0.00" : startmatch.scroreboard.value.data?.team2Crr ?? "0.00"}",
                                        style: TextStyle(
                                            color: Colors.black,
                                            fontSize: 12,
                                            fontWeight: FontWeight.bold),
