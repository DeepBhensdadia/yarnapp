    ...
    return Container(
        ...
        child: Container(
          ...
          child: Scaffold(
            ...
            body:GetBuilder<YarnCategoryController>(builder: (controller) =>  controller.yarncategorybool == true
                ? RefreshIndicator(
                color: Colors.white,
                onRefresh: () async {
                              ...
                              onPressed: (context) {
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            EditYarnCategory(
                                                yarnCategoryData: controller.getData[index])));
                              },
                            ),
                            SlidableAction(
                              borderRadius: BorderRadius.only(
                                        ...
                                        actions: <Widget>[
                                          ...
                                          TextButton(
                                              style: TextButton.styleFrom(
                                                  ...
                                                  Colors.transparent),
                                              onPressed: () async {
                                                await deleteYarnCategoryData(categoryId: controller.getData[index]?.id.toString() ??"").then((value) {
