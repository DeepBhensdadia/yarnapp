    ...
    return Container(
      ...
      child: Container(
        ...
        child: Scaffold(
          ...
          body:
      GetBuilder<FebricCategoryController>(builder: (controller) =>   controller.febricbool == true ?
      RefreshIndicator(
        color: Colors.white,
        onRefresh: () async {
                    ...
                    SlidableAction(
                      ...
                      onPressed: (context) {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => EditFabricCategory(
                            fabricCategoryData:  controller.getData[index]
                        )));
                      },
                    ),
                    SlidableAction(
                                ...
                                actions: <Widget>[
                                  ...
                                  TextButton(
                                      style: TextButton.styleFrom(
                                          ...
                                          backgroundColor: Colors.transparent),
                                      onPressed: () async {
                                        await deleteFabricCategoryData(categoryId:  controller.getData[index]?.id.toString() ??"").then((value) {
