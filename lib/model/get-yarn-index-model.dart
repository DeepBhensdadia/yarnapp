...
YarnIndexModel yarnIndexModelFromJson(String str) =>
    YarnIndexModel.fromJson(json.decode(str));
...
class YarnIndexModel {
  ...
  factory YarnIndexModel.fromJson(Map<String, dynamic> json) => YarnIndexModel(
        ...
        data: List<yarnIndexDatum?>.from(
            json["data"].map((x) => yarnIndexDatum.fromJson(x))),
      );
...
class yarnIndexDatum {
  ...
  factory yarnIndexDatum.fromJson(Map<String, dynamic> json) => yarnIndexDatum(
        ...
        yarnCategory: json["yarn_category"].toString(),
      );
